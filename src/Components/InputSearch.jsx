    ...
    <StyledWrapper>
      <div>
        ...
        <div id="search-container">
          ...
          <div id="main">
            <input className="input" name="text" type="text" placeholder="Explore the articla..." />
            <div id="input-mask" />
            <div id="cosmic-glow" />
            <div className="wormhole-border" />
            <div id="wormhole-icon" className='cursor-pointer'>
              <svg strokeLinejoin="round" strokeLinecap="round" strokeWidth={2} stroke="#A09F87" fill="none" height={24} width={24} viewBox="0 0 24 24">
...
const StyledWrapper = styled.div`
  ...
  #wormhole-icon {
    ...
    overflow: hidden;
    border-radius: 10px;
    background: linear-gradient(180deg, #4C3163, #05071B, #4C3163);
