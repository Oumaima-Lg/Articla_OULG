        ...
        <header className='pt-4 fixed top-0 right-0 left-0  bg-black/1 z-30 backdrop-blur-2xl'>
            <div className='flex justify-between items-center sm:container lg:p-[20px] p-[14px] mx-auto relative '>
                ...
                <div className='lg:hidden '>
                    ...
                    />
                    <div className={`${toggle ? "flex" : "hidden" } bg-linear-to-b from-[var(--color-start)]/45 to-[var(--color-end)]/80 absolute top-17 right-5 py-6 px-8 flex-col items-center rounded-xl gap-y-3 text-2xl`} >
                        <HeaderNav />
                    </div>
                </div>
            </div>
